  ...
  return (
    <main>
      ...
      <div className="flex flex-col pl-16 justify-center h-screen">
        <div className="font-extrabold font-lg text-[66px] w-[85%]">
          <h1>
            Inspiring
      ...
      <div className="trusted flex flex-col pl-16 justify-center bg-gradient-to-b dark:from-[#1b1b1b] dark:to-[#0e0e0e] h-[25vh]">
